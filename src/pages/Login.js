...
function Login(){
    ...
    return(
        <div className='bg-white mt-4 md:mt-6'>
          ...
          <form>
            ...
            name="password"
            className="mt-1 mb-2 w-full bg-slate-200 px-2 py-1 rounded focus-within:outline-blue"/>
            <button className="w-full max-w-[150px] m-auto bg-orange-500 hover:bg-orange-600 cursor-pointer  text-white text-xl font-medium text-center py-1 rounded-full mt-4" onclick={signIn}>
            Log In
          </button>
          </form>
            </div>
